...
<head>
    ...
    <title>{{$metaTitle?: 'TheRahat Blog'}}</title>
    <meta name="author" content="TheRahat">
...
<body class="bg-gray-50 font-family-karla">
    ...
    <!-- Topic Nav -->
    <nav class="w-full py-4 border-t border-b bg-gray-100 flex items-center justify-center" x-data="{ open: false }">
        <div class="flex-row block sm:hidden">
            <a
                href="#"
